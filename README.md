...
The parser is borrowed from `systemd` `v260` as is. Despite the original parser is slightly oversimplified and allows to do weird things,
...
- [`parse_env_file_internal`](https://github.com/systemd/systemd/blob/v260/src/basic/env-file.c#L27) — `systemd` implementation
- Useful constants:
  [`WHITESPACE`](https://github.com/systemd/systemd/blob/v260/src/fundamental/string-util-fundamental.h#L15),
  [`NEWLINE`](https://github.com/systemd/systemd/blob/v260/src/fundamental/string-util-fundamental.h#L16)
